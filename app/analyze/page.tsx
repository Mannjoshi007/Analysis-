...
async function downloadReport() {
    ...
    doc.text('KAILASH COSMOS — KRATU', M + 30, 18)

    doc.setFont('helvetica', 'normal')
    doc.setFontSize(9)
    doc.setTextColor(255, 220, 200)
    doc.text('Motor Analysis Report  —  Kratu', M + 30, 25)
    ...
    for (let p = 1; p <= totalPg; p++) {
      ...
      doc.setFontSize(9)
      doc.setTextColor(255, 255, 255)
      doc.text('KAILASH COSMOS — KRATU', W / 2, 293.5, { align: 'center' })
    }

    doc.save(filename.replace('.csv', '') + '_Kratu_Report.pdf')
    ...
    <>
      ...
      <div className="hdr">
        <div className="hdr-left">
          <span className="logo">🚀 KRATU <span>Motor Analysis</span></span>
