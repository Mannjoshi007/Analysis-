    ...
    <>
      <div className="hdr">
        ...
        <div className="hdr-right">
          ...
          <Link href="/flight" className="btn">🪂 Flight Tests</Link>
        </div>
      </div>

      <div className="home-hero">
        <h1>Static Motor Test <span>History</span></h1>
        <p>All saved KC DAQ static thrust-stand sessions — click any card to view the full interactive report, or share via link. Looking for dynamic flight-log tests? <Link href="/flight" style={{ color: 'var(--orange)' }}>Go to Flight Tests →</Link></p>
        <div className="hero-btns">
          <Link href="/analyze" className="btn primary" style={{ padding: '10px 24px', fontSize: '13px' }}>⚡ New Analysis</Link>
          <Link href="/flight" className="btn" style={{ fontSize: '13px' }}>🪂 Flight Tests</Link>
